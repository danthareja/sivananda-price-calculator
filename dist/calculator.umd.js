...
var lodash_sumby = createCommonjsModule(function (module, exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
var lodash_matchesproperty = createCommonjsModule(function (module, exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
var SeasonPriceFactory = function () {
  ...
  createClass(SeasonPriceFactory, null, [{
    ...
    value: function getSeasonFromDate(date) {
      return lodash_find(seasons, function (_ref) {
...
var ReservationCalculator = function () {
  function ReservationCalculator(_ref) {
    ...
    this.reservation = {
      adults: adults,
      children: children,
      nights: lodash_sumby(stays, function (stay) {
  ...
  createClass(ReservationCalculator, [{
    ...
    value: function getTotalRoom() {
      return lodash_round(lodash_sumby(lodash_values(this.getDailyRoomYVP()), 'room'), 2);
    }
  }, {
    key: 'getTotalYVP',
    value: function getTotalYVP() {
      return lodash_round(lodash_sumby(lodash_values(this.getDailyRoomYVP()), 'yvp'), 2);
    }
  }, {
    key: 'getTotalCourse',
    value: function getTotalCourse() {
      return lodash_round(lodash_sumby(this.courses, function (course) {
